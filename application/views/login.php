  ...
  <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
    <div class="container">
      ...
      <div class="navbar-translate">
        <a class="navbar-brand" href="<?php echo base_url(''); ?>" rel="tooltip" title="APLIKASI ARSIP VIDEO PEMERINTAH PROVINSI JAWA TENGAH" data-placement="bottom" target="_blank">SIKD Jateng</a>
            ...
            <form class="form" method="post">
              <div class="card-header text-center">
                <div class="logo-container">
                  <img src="<?php echo base_url('./assets/logo/logo.png'); ?>" alt="" style="">
                </div>
              </div>
              <div class="card-body">
    ...
    <footer class="footer">
      <div class="container">
        <div class="copyright" id="copyright">
          ...
          <a href="https://lingkungan.ft.undip.ac.id" target="_blank">APLIKASI ARSIP VIDEO PEMERINTAH PROVINSI JAWA TENGAH</a> &nbsp; X  &nbsp;
          <a target="_blank"></a>.
        </div>
      </div>
    </footer>
